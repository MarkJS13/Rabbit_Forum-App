            ...
            <section class="sidebarL">
                ...
                <main>
                    ...
                    <div class="create-question">
                        <h2> Edit a question <span><i class="fa-solid fa-signs-post"></i></span>
                            <div class="close">
                        ...
                        <div class="create-question-form">
                            <form action="{{ route('question.update', $question->id) }}" method="post">
                                @csrf
                                @method('patch')
                                <input type="text" placeholder="Title" name="title" value="{{ $question->title }}">
                                <textarea name="content" placeholder="Text">{{ $question->content }}</textarea>
